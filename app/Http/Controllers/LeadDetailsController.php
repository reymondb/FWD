    ...
    public function fetchDetails(Request $request)
    {
        ...
        if($getcampaign){
            ...
            foreach($getcampaign as $k=>$c){
                ...
                $dataz = DB::connection('mysql_external')
                    ->table('vicidial_list')
                    ->select('vicidial_list.phone_number','vicidial_list.lead_id','vicidial_log.status','vicidial_statuses.status_name','vicidial_log.call_date','vicidial_list.entry_date','vicidial_log.campaign_id')
