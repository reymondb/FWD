            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function(k, v) {
                        ...
                        $('#leadstatslists').append('<tr class="'+bgcolor3+' '+bgcolor+' '+bgcolor2+'"><td>'+v.status+'</td><td class="">'+status_name+'</td><td class="right">'+(v.total).toLocaleString()+'</td><td class="right">'+(v.total / v.overalltotal).toFixed(2)+'</td><td class="right">'+v.total1+'</td><td class="right">'+(v.total1 / v.overalltotal).toFixed(2)+'</td><td class="right">'+numberWithCommas(v.total2)+'</td><td class="right">'+(v.total2 / v.overalltotal).toFixed(2)+'</td><td class="right">'+numberWithCommas(v.total3)+'</td><td class="right">'+(v.total3 / v.overalltotal).toFixed(2)+'</td><td class="right">'+numberWithCommas(v.total4)+'</td><td class="right">'+(v.total4 / v.overalltotal).toFixed(2)+'</td><td class="right">'+numberWithCommas(v.total5)+'</td><td class="right">'+(v.total5 / v.overalltotal).toFixed(2)+'</td><td class="right">'+numberWithCommas(v.total6)+'</td><td class="right">'+(v.total6 / v.overalltotal).toFixed(2)+'</td></tr>');
                    });
                        ...
                        "initComplete": function (settings, json) {
                            if(this.fnSettings().aoData.length===0) {
                                ...
                                this.api().columns('.sum').every(function () {
                                    ...
                                    .data()
                                    .reduce(function (a, b) { 
                                        a = parseInt(a.toString().replace(/,/g, ''), 10);
                                        if(isNaN(a)){ a = 0; }
                                        b = parseInt(b.toString().replace(/,/g, ''), 10);
                                        if(isNaN(b)){ b = 0; }
