    ...
    <script>
        ...
        function fetchLeadStatList(){
            $.ajax({
                ...
                processData: false,
                success: function (data) {
                    $("#reportholder").html("<table id='leadstatslists' class='table'><tr><th colspan='2'>From vicidial_list</th></tr><tr><th style='width=\"200px\"'>Status</th><th style='width=\"200px\">Total</th></tr></table>");
                    //$('#list_id').empty().append('<option selected="selected" value="">Select List ID</option>');
                    $.each(data, function(k, v) {
