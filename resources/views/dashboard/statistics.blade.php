            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function(k, v) {
                        ...
                        $('#leadstatslists').append('<tr><td>'+v.status+'</td><td>'+v.status_name+'</td><td>'+v.total+'</td><td>'+(v.total / v.overalltotal).+'</td><td>'+v.total1+'</td><td>'+(v.total1 / v.overalltotal).+'</td><td>'+v.total2+'</td><td>'+(v.total2 / v.overalltotal).+'</td><td>'+v.total3+'</td><td>'+(v.total3 / v.overalltotal).+'</td><td>'+v.total4+'</td><td>'+(v.total4 / v.overalltotal).+'</td><td>'+v.total5+'</td><td>'+(v.total5 / v.overalltotal).+'</td><td>'+v.total6+'</td><td>'+(v.total6 / v.overalltotal).+'</td></tr>');
                    });
